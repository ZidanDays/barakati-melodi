        ...
        <div class="sidebar" data-background-color="dark">
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="m" class="logo">
                        <img src="../assets/img/simoptik2.png" alt="navbar brand" class="navbar-brand" height="45" />
                    </a>
                                ...
                                <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
                                    <div class="avatar-sm">
                                        <?php if (isset($_SESSION['profile_pic']) && !empty($_SESSION['profile_pic'])) : ?>
                                            <img src="<?php echo $_SESSION['profile_pic'] ?>" alt="..." class="avatar-img rounded-circle" />
                                        <?php else : ?>
                                    ...
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        <li>
                                            <div class="user-box">
                                                <div class="avatar-lg">
                                                    <?php if (isset($_SESSION['profile_pic']) && !empty($_SESSION['profile_pic'])) : ?>
                                                        <img src="<?php echo $_SESSION['profile_pic'] ?>" alt="..." class="avatar-img rounded" />
                                                    <?php else : ?>
                                                        <img src="../assets/img/avatar.png" alt="..." class="avatar-img rounded" />
                                                    <?php endif; ?>
                                                </div>
                                                <div class="u-text">
                                        ...
                                        <li>
                                            ...
                                            <a class="dropdown-item" href="?q=profile">My Profile</a>
