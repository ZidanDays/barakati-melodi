    ...
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-light">
        <a href="#" class="navbar-brand p-0">
          ...
          <img src="img/Bm logo-01.png" alt="Logo">
        </a>
        <button
          ...
          <div class="navbar-nav mx-0 mx-lg-auto">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <a href="/catalog-management" class="dropdown-item">Catalog Management</a>
                  <a href="/distribution-and-delivery" class="dropdown-item">Distribution & Delivery</a>
                  <a href="/analytics-and-reporting" class="dropdown-item"
        ...
        <div class="d-none d-xl-flex flex-shrink-0 ps-4">
          ...
          <div class="d-flex flex-column ms-3">
            ...
            <a href="tel:082296906125"
              ><span class="text-dark">082296906125</span></a
            >
          </div>
        </div>
      </nav>
